...
def create_validator_recommendation_ia_question_schema_pdf():
    return CustomValidator(schema=recommendation_ia_question_schema_pdf)

def create_validator_recommendation_ia_with_number_question_schema():
    return CustomValidator(schema=recommendation_ia_with_question_schema)
