...
from utils.config import ANTHROPIC_API_KEY, MAX_TOKENS_ANTHROPIC, ANTHROPIC_MODEL, ARRAY_API_KEY
...
def create_anthropic_haiku_client_instance():
    strategy = AnthropicStrategy(api_key=ANTHROPIC_API_KEY, model=ANTHROPIC_MODEL, max_tokens=MAX_TOKENS_ANTHROPIC, timeout_seconds=25)
