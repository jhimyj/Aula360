...
from utils.validator import (
    create_validator_recommendation_ia_question_schema_pdf
)
...
from utils.prompt import prompt_recommendation_pdf
from utils.helper_functions import extract_delimited_text
from utils.extract_text_pdf_b64 import extract_text_from_base64_pdf
...
_validator_promt_user = create_validator_recommendation_ia_question_schema_pdf()
...
def lambda_handler(event, context):
    ...
    try:
        ...
        pdf_base_64 = body['pdf_base64']

        try:
            text = extract_text_from_base64_pdf(pdf_base_64)
        except Exception as err:
        ...
        try:
            ...
            prompt_final = prompt_recommendation_pdf(course,topic,text)
